...
The game looks for short MP3 voice clips in `audio/voice/`. When a powerup activates or a key event happens, it tries to play the matching clip. If the file is missing, it falls back to a synthesized horn-stab + crowd-roar stinger — arcade-y, intentionally retro, no robot voice.

**Files the game looks for:**

Generic events (any free announcer pack works):
- `audio/voice/fight.mp3` — start of every rally
- `audio/voice/raya.mp3` — after a regular score
- `audio/voice/hoop.mp3` — after a hoop score (+3)
- `audio/voice/you_win.mp3` — match-over winner banner

Powerup names (must say the specific name):
- `jaguar_step.mp3`, `lightning_knee.mp3`, `obsidian_edge.mp3`, `stone_hide.mp3`, `quetzal_cloak.mp3`, `hummingbird_wings.mp3`, `smoke_trail.mp3`, `twin_sun.mp3`

### Recommended voice pack for the generic events

[**VoiceBosch's "Mr. Happy" announcer pack**](https://opengameart.org/content/mr-happy-announcer-audio-pack) on OpenGameArt — high-energy fighting-game announcer, CC-BY-SA 4.0, free. The pack has phrases like "Fight!", "Victory!", "You Win!" that map directly to the generic events. Rename the files to match the game's filename convention.

### For the powerup names

You have three options:

1. **Record them yourself.** Open your phone's voice memo, shout each powerup name with maximum announcer gusto, export as MP3, drop in. This will sound *better* than any free pack because the energy will match your specific names.
2. **Hire a voice actor** — Fiverr has $5-15 announcers who'll do all 8 in one take.
3. **Skip it.** The synth stinger sounds intentional and arcade-y. Just the visual flash + horn stab + crowd roar — you don't *have* to have speech for the game to feel good.

See `audio/voice/README.txt` for the full filename list.
