// Hand-authored gameplay tuning for MB4D v2 (Level 1 vertical slice, new controls).
//
...
// spreadsheet it is a deliberate balance choice — see docs/spec-gaps-v2.md.
...
export const CFG = {
  ...
  player: {
    ...
    accel: 60,
    turnSpeed: 3.4,      // radians/sec — W/D yaw rate (v2 controls)
