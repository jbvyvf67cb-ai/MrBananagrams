...
export const CFG = {
  ...
  bosses: {
    ...
    // Boss 4: "particle colider" — Data7 row 5. 3000 hp, 5 phases:
    //   p2: boss appears after button (initial)
    //   p3 at hp 2400 (80%): "dozens of enemies surround it"
    //   p4 at hp 1800: "billions of enemies"
    //   p5 at hp 1500: "longest phase" — boss drops bombs from above
    // Phases beyond 5 are not specified in the sheet; we use 5 thresholds.
    particlecolider: {
      hp: 3000,
      phase2At: 1.0,            // appears at full hp after the button
      phase3At: 0.80, phase4At: 0.60, phase5At: 0.50,
