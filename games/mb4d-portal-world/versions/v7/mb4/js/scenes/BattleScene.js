...
const BATTLE = {
  ...
  DMG: { crunch: 30, slam: 32, hip: 26, stomp: 20 },   // verbatim from Data6
  INVULN_MS: 900,
  ENEMY: {
...
class BattleScene extends Phaser.Scene {
  ...
  _updateBoss(dt, time) {
    ...
    if (b.phase2 && time > b.nextShotAt) {
      b.nextShotAt = time + 1800;
      this._spawnFireball(b.x, b.depth, mb.x, mb.depth, 260, BATTLE.BOSS.fireballDmg);
    }
  }
