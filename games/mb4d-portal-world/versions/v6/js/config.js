...
export const CFG = {
  ...
  // (v5: the Babylon Hipball mini-game is gone — replaced by the real MB4
  // Hipball mini-game embedded as an iframe at `versions/v5/mb4/`. Hipball
  // tuning now lives there in `mb4/js/main.js` under MB4.STRIKES / MB4.BALL.)
